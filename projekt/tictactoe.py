...
class Menu:
    ...
    #jezeli gracz wybierze X tworzymy plansze do gry z pomoca tej metody
    ...
    def generateBoard(self):
        ...
        self.b1 = Button(self.root,text = "b1", bg="AntiqueWhite1", fg="AntiqueWhite1",image = self.img,command=lambda: self.click(self.b1) )
        self.b2 = Button(self.root,text = "b2", bg="AntiqueWhite1", fg="AntiqueWhite1",image = self.img,command=lambda: self.click(self.b2))
        self.b3 = Button(self.root,text = "b3", bg="AntiqueWhite1", fg="AntiqueWhite1",image = self.img,command=lambda:self.click(self.b3))
        self.b4 = Button(self.root,text = "b4", bg="AntiqueWhite1", fg="AntiqueWhite1",image = self.img,command=lambda:self.click(self.b4))
        self.b5 = Button(self.root,text = "b5", bg="AntiqueWhite1", fg="AntiqueWhite1",image = self.img,command=lambda:self.click(self.b5))
        self.b6 = Button(self.root,text = "b6", bg="AntiqueWhite1", fg="AntiqueWhite1",image = self.img,command=lambda:self.click(self.b6))
        self.b7 = Button(self.root,text = "b7", bg="AntiqueWhite1", fg="AntiqueWhite1",image = self.img,command=lambda:self.click(self.b7))
        self.b8 = Button(self.root,text = "b8", bg="AntiqueWhite1", fg="AntiqueWhite1",image = self.img,command=lambda:self.click(self.b8))
        self.b9 = Button(self.root,text = "b9", bg="AntiqueWhite1", fg="AntiqueWhite1",image = self.img,command=lambda:self.click(self.b9))
    ...
    #funkcja ktora oblicza opytmalny ruch dla komputera
    def best_move(self):
        bestScore = -99999
        for i in range(3):
            for j in range(3):
    ...
    def click(self,button):
         if( self.player == "O"):
            button.config(image=self.kolko,state=DISABLED,width=266,height=266)
            self.updateBoard(button, self.player)
    ...
    def newGame(self):
        ...
        label = Label(self.root, text="Choose your figure", bg="salmon", fg="black", font=myFont, width=30)
